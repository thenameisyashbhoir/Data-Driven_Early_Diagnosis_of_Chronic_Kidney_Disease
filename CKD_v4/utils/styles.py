...
/* Keep deploy button visible, only hide the 3-dot hamburger menu */
#MainMenu { visibility: hidden !important; }
[data-testid="stToolbar"] [data-testid="stToolbarActionButtonIcon"]:not([title*="Deploy"]) { display: none !important; }
/* Hide the 3-dots options menu specifically */
