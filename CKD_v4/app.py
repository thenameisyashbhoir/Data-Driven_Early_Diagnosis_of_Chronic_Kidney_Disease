"""
app.py  ──  CKD Early Diagnosis System — Main Entry Point
...
with st.sidebar:
    ...
    if role == "admin":
        NAV_GROUPS = [
            ...
            ("HEALTH TOOLS",["AI Assistant", "Diet Plan"]),
...
elif page == "AI Assistant"     : from pages.chatbot          import render; render()
elif page == "Diet Plan"        : from pages.diet_plan        import render; render()
